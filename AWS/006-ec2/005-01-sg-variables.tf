...
variable "vpc_01_sg_02_name" {
  description = "Name of Security Group 02"
  type        = string
}

variable "vpc_01_sg_02_ingress_rules" {
  description = "List of Ingress Rules in Security Group 02"
  type = list(object({
    description = optional(string)
    from_port   = number
    to_port     = number
